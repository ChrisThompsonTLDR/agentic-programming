...
metadata:
  author: laravel
---
> **Synced from** [`laravel/boost`](https://github.com/laravel/boost) @ `14a5c6ab6729a8bb108bc5a29280fe53e5da6abd` — `.ai/pest/4/skill/pest-testing/SKILL.blade.php`. Regenerate: `python3 scripts/sync-boost-ai-skills.py`.
