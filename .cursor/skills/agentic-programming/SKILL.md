...
These secrets are referenced by the MCP server config in `.steering/agents/laravel-package.agent.md` (mirrored under `.github/agents/`).
...
| `.steering/mcps/` | Output directory for MCP server research notes |
